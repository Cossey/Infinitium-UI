  ...
  <f7-page name="settings" :page-content="false">
    ...
    <f7-toolbar tabbar labels bottom>
      ...
      <f7-link
        ...
        icon-aurora="material:cloud_upload"
    ...
    <f7-tabs ref="settingInputs">
      <f7-tab id="server" class="page-content" tab-active>
        ...
        <f7-block-title>Service and Web Interface</f7-block-title>
        <f7-list no-hairlines-md>
          <f7-list-input
        ...
        <f7-block-title>IPv6</f7-block-title>
      ...
      <f7-tab id="dns" class="page-content">
        <f7-block-title>DNS Protocols</f7-block-title>
        <div class="block">
          <p>
        ...
        <f7-block-title>DNS Forwarding</f7-block-title>
        <div class="block">
          <p>
        ...
        <f7-list no-hairlines-md>
          <f7-list-item
            ...
            v-model:checked="settings.allowRecursion"
          ></f7-list-item>
          <f7-list-item
            checkbox
            title="Recursion Only For Private Networks"
            :disabled="settings.allowRecursion === false"
            v-model:checked="settings.allowRecursionOnlyForPrivateNetworks"
          ></f7-list-item>
          <f7-list-item
            checkbox
      ...
      <f7-tab id="cache" class="page-content">
        ...
        <f7-list no-hairlines-md>
          ...
          <f7-block-footer>
            <p>
              The DNS Server cache auto prefetch option can keep eligible domain
              names from last hour stats "hot" in cache. Auto prefetch
              eligibility value can be decided by keeping an eye on the hits
              shown for last hour on the dashboard. Experiment with auto
              prefetch sampling interval and eligibility to get best results.
            </p>
          </f7-block-footer>
        </f7-list>
      </f7-tab>
      ...
      <f7-tab id="logging" class="page-content">
        ...
        <f7-list no-hairlines-md>
          ...
          <f7-block-footer>
            <p>
              Warning! Enabling query logging will significantly increase the
    ...
    <f7-actions id="actions-tools">
      <f7-actions-group>
        <f7-actions-button @click="backupSettings()"
          >Backup Settings</f7-actions-button
        >
        <f7-actions-button @click="restoreSettings()"
          >Restore Settings</f7-actions-button
        >
      </f7-actions-group>
      <f7-actions-group>
